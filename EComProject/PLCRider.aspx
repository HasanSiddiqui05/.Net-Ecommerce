<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PLCRider.aspx.cs" Inherits="EComProject.PLCRider" %>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="section-3">
            <div class="btn-row">
                <button class="save-btn" runat="server" onserverclick="Button1_Click">Create Rider Account</button>
            </div>
        </div>
    </div>
    </form>
